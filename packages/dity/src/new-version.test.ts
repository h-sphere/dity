...
describe('Dity', () => {
    it('should properly inject basic deps', () => {
        const a = new Registrator()
            .register('a', 5)
            .register('b', 'hello')
            .register('c', d => d.fn((a: number, b: string) => a + ' ' + b).inject('a', 'b'))
    ...
    it('should properly setup submodules', () => {
        ...
        const mod = new Registrator()
            ...
            .import<'iii', number>()
            .module('mod', sub)
            .register('fn', d => d.fn((a: number, b: string) => a + b).inject('iii', 'mod.c'))
            .link('iii', 'mod.a')
            .link('mod.imp', 'fn')
            .build()
    ...
    it('should register multiple values at the same time', () => {
        const a = new Registrator()
            ...
            .register('fn', d => d.fn((a: number, b: number) => a + b).inject('a', 'a'))
            .build()
