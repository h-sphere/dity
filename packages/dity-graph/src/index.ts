import { inspect, type Registrator } from '@hypersphere/dity'
...
export class DityGraph {
	...
	deps: ReturnType<typeof inspect> | null = null

	render() {
		// FIXME: to be finished later.
		...
		// 			color: chroma(moduleColor(dep.module))
		// 				.brighten(2)
		// 				.desaturate(2)
		// 				.hex(),
		// 			type: 'border'
		...
		// 	switch (d.type) {
		// 		case 'reference':
		// 			this.graph.addEdge(d.key, d.ref, {
		// 				size: 3,
		// 				color: '#666',
		// 				type: 'arrow'
		// 			})
		...
		// 		case 'configuration':
		// 			d.deps.forEach(dep => {
		// 				this.graph.addEdge(d.key, dep.ref, {
		// 					size: 3,
		// 					color: '#666',
		// 					type: 'arrow'
		// 				})
