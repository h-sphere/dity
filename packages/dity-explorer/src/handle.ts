...
const graphContainer = document.querySelector<HTMLDivElement>('#graph-container-element')!
const mainContainer = document.querySelector<HTMLDivElement>('#graph-container')!

let lastRatio = 0.5


export const handleHandle = (container: HTMLElement, handle: HTMLDivElement, graph: () => DityGraph | null, editor: editor.IStandaloneCodeEditor) => {
